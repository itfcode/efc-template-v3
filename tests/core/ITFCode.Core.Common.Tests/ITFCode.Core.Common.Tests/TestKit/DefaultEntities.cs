...
namespace ITFCode.Core.Common.Tests.TestKit
{
    ...
    public class DefaultData
    {
        ...
        public static ProductTc ProductA => EntityGenerator.CreateProduct(1, "ProductA", "FR");
        public static ProductTc ProductB => EntityGenerator.CreateProduct(2, "ProductB", "SE");
        public static ProductTc ProductC => EntityGenerator.CreateProduct(3, "ProductC", "EN");
