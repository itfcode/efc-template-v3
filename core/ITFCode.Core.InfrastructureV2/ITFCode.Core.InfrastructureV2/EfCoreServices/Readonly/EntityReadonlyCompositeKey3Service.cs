...
{
    public class EntityReadonlyService<TDbContext, TEntity, TKey1, TKey2, TKey3> : EntityReadonlyBaseService<TDbContext, TEntity>,
        IEntityReadonlyService<TEntity, TKey1, TKey2, TKey3>
        ...
        where TDbContext : DbContext
    {
        ...
        #region IEntityReadonlyService<TEntity, TKey1, TKey2, TKey3>
        ...
        protected Expression<Func<TEntity, bool>> BuildPredicate(IEnumerable<(TKey1, TKey2, TKey3)> keys)
            => ExpressionHelper.BuildPredicate<TEntity, TKey1, TKey2, TKey3>(keys, GetKeyPropertyNames());
