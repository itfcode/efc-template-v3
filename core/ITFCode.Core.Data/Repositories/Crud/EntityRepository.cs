...
using ITFCode.Core.Data.Repositories.Crud.Interfaces;
using ITFCode.Core.Domain.Entities.Base.Interfaces;
using Microsoft.EntityFrameworkCore;

namespace ITFCode.Core.Data.Repositories.Crud
{
        ...
        where TDbContext : DbContext
    {
        ...
        private EfEntityCreater<TDbContext>? _dbCreater;
        private EfEntityReader<TDbContext>? _dbReader;
        private EfEntityUpdater<TDbContext>? _dbUpdater;
        private EfEntityDeleter<TDbContext>? _dbDeleter;
        ...
        protected EfEntityCreater<TDbContext> DbCreater => _dbCreater ??= new EfEntityCreater<TDbContext>(DbContext);
        protected EfEntityReader<TDbContext> DbReader => _dbReader ??= new EfEntityReader<TDbContext>(DbContext);
        protected EfEntityUpdater<TDbContext> DbUpdater => _dbUpdater ??= new EfEntityUpdater<TDbContext>(DbContext);
        protected EfEntityDeleter<TDbContext> DbDeleter => _dbDeleter ??= new EfEntityDeleter<TDbContext>(DbContext);
