...
namespace ITFCode.Core.Data.Repositories.Crud
{
            ...
            where TDbContext : DbContext
    {
        ...
        public virtual IReadOnlyCollection<TEntity> GetRange(IEnumerable<TKey> keys)
        {
            try
            {
        ...
        public virtual async Task<IReadOnlyCollection<TEntity>> GetRangeAsync(IEnumerable<TKey> keys, CancellationToken cancellationToken = default)
        {
            try
            {
