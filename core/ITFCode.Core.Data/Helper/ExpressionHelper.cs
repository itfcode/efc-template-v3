...
namespace ITFCode.Core.Data.Extensions.Helper
{
    public static class ExpressionHelper
    {
        ...
        public static Expression<Func<TSource, bool>> BuildPredicate<TSource>(IEnumerable<object> values, string propertyName)
        {
            if (string.IsNullOrEmpty(propertyName))
                throw new ArgumentOutOfRangeException("Primary Key Property Name Not Defined");
        ...
        public static Expression<Func<TSource, bool>> BuildPredicate<TSource>(IEnumerable<(object, object)> keys, string[] propertyNames)
        {
            if (propertyNames.Length != 2)
                throw new ArgumentOutOfRangeException("Number Of Property Names Should Be Equals To 2");
        ...
        public static Expression<Func<TSource, bool>> BuildPredicate<TSource>(IEnumerable<(object, object, object)> keys, string[] propertyNames)
        {
            if (propertyNames.Length != 3)
                throw new ArgumentOutOfRangeException("Number Of Property Names Should Be Equals To 3");
